...
import vn.quantda.apiBoot.process.AbstractServer
import vn.quantda.apiBoot.process.BootRunServer

class StartBackendServerTask extends DefaultTask {
	...
	@TaskAction
	def action() {
		BootRunServer server = new BootRunServer()
